...
// Trust proxy for rate limiting behind local parsers/proxies
...
import userTagRoutes from './routes/user-tag.routes';
...
app.use('/api/v1/user-tags', userTagRoutes);
